...
notCyclic :: CList a -> P.Bool
notCyclic (CL _ []) = P.True
notCyclic _         = P.False
...
definatelyCyclic :: CList a -> P.Bool
definatelyCyclic (CL _ []) = P.False
definatelyCyclic _         = P.True
...
justCyclic :: CList a -> P.Bool
justCyclic (CL [] _) = P.True
justCyclic _         = P.False
